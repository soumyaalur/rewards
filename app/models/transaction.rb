class Transaction < ApplicationRecord
  ...
  def self.spend!(user_id, params)
    raise "Params cannot be empty" if params.empty?

    user = User.find(user_id)
    rem_points = params[:points]
  ...
  def self.deduct_points(transactions, payers_total, rem_points)
